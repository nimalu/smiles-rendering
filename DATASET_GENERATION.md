...
This document describes how to generate a YOLO format instance segmentation dataset from SMILES molecular structures.

## Overview

The `generate_dataset.py` script creates a complete dataset ready for training YOLO instance segmentation models. It:
